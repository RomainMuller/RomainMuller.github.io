...
<div id="code1p" class="accordion">
  <div class="accordion-item">
    <div class="accordion-header">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#code1" aria-expanded="false" aria-controls="code1">
        Here's what it may look like for a simple "hello, world" application:
      </button>
    </div>
    <div id="code1" class="accordion-collapse collapse" data-bs-parent="#code1p">
